...
const Button: React.FC<ButtonProps> = ({
  ...
  const variantClasses = {
    primary: 'bg-gradient-to-r from-[#F9F295] via-[#E0AA3E] to-[#FBF499] hover:from-[#E0AA3E] hover:via-[#F9F295] hover:to-[#E0AA3E] rounded-md text-black font-semibold px-6 py-3 rounded-lg transition-all duration-300 ease-in-out',
