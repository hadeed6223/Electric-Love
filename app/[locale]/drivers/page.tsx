            ...
            {features.map((feature, index) => (
              <div key={index} 
                ...
                <div className="relative z-20 mb-8">
                  ...
                  >
                    <feature.icon className="w-8 h-8 text-[#AF8D2C] transition-all duration-300 group-hover:text-[#F9F295]" />
                  </div>
                </div>
            ...
            {benefits.map((benefit, index) => (
              ...
              <div className="relative z-20 mb-8">
                <div 
                  className="w-16 h-16 rounded-2xl flex items-center justify-center border border-white/30 bg-white/20 backdrop-blur-sm transition-all duration-300 group-hover:scale-110 group-hover:rotate-3 shadow-lg"
                >
                  <benefit.icon className="w-8 h-8 text-[#AF8D2C] transition-all duration-300 group-hover:text-[#F9F295]" />
                </div>
              </div>
